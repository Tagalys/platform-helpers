...
var RecentViewed = /** @class */ (function () {
    function RecentViewed(requestState, responseState) {
    ...
    RecentViewed.prototype.apiClient = function () {
        return new shopifyApi_1.default();
    };
    RecentViewed.prototype.formatProductGids = function (productIds) {
        return productIds.map(function (id) { return "gid://shopify/Product/".concat(id); });
    };
    RecentViewed.prototype.getMetafieldVariables = function () {
    ...
    RecentViewed.prototype.getQuery = function () {
    ...
    RecentViewed.prototype.getQueryVariables = function () {
        return __assign({ ids: this.formatProductGids(this.requestState.productIds) }, this.getMetafieldVariables());
    };
    RecentViewed.prototype.formatResponse = function (_, shopifyResponse) {
        var _this = this;
    ...
    RecentViewed.prototype.helpersToExpose = function () {
        var _this = this;
        return {
