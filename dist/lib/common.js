...
var applyCurrencyConversion = function (number) {
    if (number !== null) {
        var exchangeRate = global_context_1.default.configuration.getExchangeRate();
        var fractionalDigits = global_context_1.default.configuration.getFractionalDigits();
