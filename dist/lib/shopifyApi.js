...
var ShopifyAPI = /** @class */ (function () {
    ...
    ShopifyAPI.prototype.call = function (method, path, requestOptions, headers) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (requestOptions.hasOwnProperty("onSuccess")) {
                            return [2 /*return*/, requestOptions.onSuccess(parsedResponse.data)];
                        }
                        return [2 /*return*/, parsedResponse.data];
                    case 3:
    ...
    ShopifyAPI.prototype.url = function (path) {
        return "https://".concat(global_context_1.default.shopifyConfiguration.getMyShopifyDomain(), "/api/").concat(common_1.API_VERSION, "/").concat(path);
    };
    return ShopifyAPI;
}());
exports.default = ShopifyAPI;
//# sourceMappingURL=shopifyApi.js.map